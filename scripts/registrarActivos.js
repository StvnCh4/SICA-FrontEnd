...
window.onload = function () {
  ...
  registrarActivo.addEventListener(
    "click",
    async function registrarActivoFuct(e) {
      e.preventDefault();
      ...
      //Código Ubicacion
      let valueUbicacion =
        activeLocation.options[activeLocation.selectedIndex].text;
      let valuePiso = activePiso.options[activePiso.selectedIndex].text;
      let codigoUbicacion =
        "pro" + valueUbicacion.substr(0, 3) + "pis" + valuePiso;
